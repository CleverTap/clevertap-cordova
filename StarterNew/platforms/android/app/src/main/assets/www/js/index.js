...
var app = {
    ...
    onDeviceReady: function() {
        ...
        //Sample code to manage Notification Channels for Android O
        //CleverTap.createNotificationChannel("cordovaId","Cordova Channel","Cordova Android O Channel",4,true);
        //CleverTap.createNotificationChannelGroup("groupId","First Group");
        //CleverTap.createNotificationChannelWithGroupId("channelId","First Channel","First Channel in First Group",1,"groupId",true);
        //CleverTap.deleteNotificationChannel("cordovaId");
        //CleverTap.deleteNotificationChannelGroup("groupId");

        //Sample CleverTap Usage 
                /*
                CleverTap.registerPush();
                CleverTap.setDebugLevel(3); //-1 = OFF, 0 = INFO, 2 = DEBUG, 3 = VERBOSE
